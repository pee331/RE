// src/lib.rs
/*
 * Core library for RESTFramework
 */
...
#[derive(Debug)]
pub struct RESTFrameworkProcessor {
    verbose: bool,
    processed_count: usize,
}

impl RESTFrameworkProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting RESTFramework processing");
    
    let mut processor = RESTFrameworkProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = RESTFrameworkProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = RESTFrameworkProcessor::new(false);
